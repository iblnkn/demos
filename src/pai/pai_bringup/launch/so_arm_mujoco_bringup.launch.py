...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            'roll', default_value='0.0', description='Robot arm base roll orientation (radians)'
        ),
        DeclareLaunchArgument(
            'pitch', default_value='0.0', description='Robot arm base pitch orientation (radians)'
        ),
        DeclareLaunchArgument(
            'yaw', default_value='3.14159', description='Robot arm base yaw orientation (radians)'
        ),
    ]
